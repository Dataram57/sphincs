...
//SLH-DSA-SHAKE-128s
export const slh_dsa_shake_128s = new SphincsVariant(
...
//SLH-DSA-SHAKE-128f
export const slh_dsa_shake_128f = new SphincsVariant(
    new Shake_VariantTools(
        16,66,22,16,33,6,34
    ),
    adrsDefault
...
//SLH-DSA-SHAKE-192s
export const slh_dsa_shake_192s = new SphincsVariant(
    new Shake_VariantTools(
        24,63,7,16,17,14,39
    ),
    adrsDefault
...
//SLH-DSA-SHAKE-192f
export const slh_dsa_shake_192f = new SphincsVariant(
    new Shake_VariantTools(
        24,66,22,16,33,8,42
    ),
    adrsDefault
...
//SLH-DSA-SHAKE-256s
export const slh_dsa_shake_256s = new SphincsVariant(
    new Shake_VariantTools(
        32,64,8,16,22,14,47
    ),
    adrsDefault
...
//SLH-DSA-SHAKE-256f
export const slh_dsa_shake_256f = new SphincsVariant(
    new Shake_VariantTools(
        32,68,17,16,35,9,49
    ),
    adrsDefault
